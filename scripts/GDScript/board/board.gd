...
@onready var hoboxHand = $MarginContainer/HBoxContainer
...
func _ready() -> void:
	hoboxHand.anchor_left = 0.0
	hoboxHand.anchor_right = 1.0 # Faz ele ocupar toda a largura
	
	hoboxHand.anchor_top = 0.8 # Ajusta para ficar na parte de baixo da tela
	hoboxHand.anchor_bottom = 1.0
